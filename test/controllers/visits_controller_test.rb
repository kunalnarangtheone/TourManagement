...
class VisitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visit" do
    assert_difference('Visit.count') do
      post visits_url, params: { visit: { location_id: @visit.location_id, tour_id: @visit.tour_id } }
    end
  ...
  test "should update visit" do
    patch visit_url(@visit), params: { visit: { location_id: @visit.location_id, tour_id: @visit.tour_id } }
